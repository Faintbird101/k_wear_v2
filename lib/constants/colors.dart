...
class AppColors {
  ...
  final Color greylight = const Color(0xFFD8D9DA);
  ...
  ThemeData themeData() {
    ...
    TextTheme txtTheme = (isDark ? ThemeData.dark() : ThemeData.light()).textTheme.apply(fontFamily: 'Causten');
    ...
    var t = ThemeData.from(textTheme: txtTheme, colorScheme: colorScheme).copyWith(
      textSelectionTheme: TextSelectionThemeData(cursorColor: brown, selectionColor: brown),
